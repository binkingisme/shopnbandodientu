...
<head>
<!-- Google tag (gtag.js) -->
<script async src="https://www.googletagmanager.com/gtag/js?id=G-YN6HY1CG0Y"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'G-YN6HY1CG0Y');
</script>
...
s1.async=true;
s1.src='https://embed.tawk.to/694d048e420bc819787f8241/1jdadjk3b';
s1.charset='UTF-8';
